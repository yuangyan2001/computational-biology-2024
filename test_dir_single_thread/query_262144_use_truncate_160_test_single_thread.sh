...
for i in 1 2 3
do
perf stat -d -d -d -o ./single_thread_result/query_262144_use_truncate_160_single_thread_res_$i  blastn -db $SLURM_TMPDIR/db/nt -query $SLURM_TMPDIR/query/query_262144_use_truncate_160 -out results.out -evalue 1e-5 -num_threads 1
done
